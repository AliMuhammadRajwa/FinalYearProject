...
<header id="header" class="d-flex align-items-center ">
    <div class="container-fluid container-xxl d-flex align-items-center">
        ...
        <div id="logo" class="me-auto">
            ...
            <a href="{{route('LoadMainPage')}}" class="scrollto"><img src="{{asset('img/logo1.png')}}" alt="" title=""></a>
        </div>

        <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
                <li><a class="nav-link scrollto active" href="{{route('LoadMainPage')}}">Home</a></li>
                <li><a class="nav-link scrollto" href="#about">Hotel</a></li>
                <li><a class="nav-link scrollto" href="#speakers">Tour Plan</a></li>
                <li><a class="nav-link scrollto" href="#hotels">Tour Guide</a></li>
                <li><a class="nav-link scrollto" href="#schedule">Transportation</a></li>
                <li><a class="nav-link scrollto" href="#venue">Rent Car</a></li>
                <li><a class="nav-link scrollto" href="#venue">Mechanics</a></li>
                <li><a class="nav-link scrollto" href="#gallery">Contact Us</a></li>
                <li><a class="nav-link scrollto" href="#supporters">About</a></li>
        ...
        <a class="buy-tickets scrollto" href="{{route('adminPage')}}">Login</a>
...
<section id="hero">
    <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
        <h1 class="mb-4 pb-0">North Trip Cycle<br></h1>
        <p class="mb-4 pb-0">We Plan, We Design, We Serve</p>
    ...
    <section id="gallery">
        ...
        <div class="gallery-slider swiper">
            <div class="swiper-wrapper align-items-center">
                <div class="swiper-slide"><a href="{{asset('img/gallery/1.jpg')}}" class="gallery-lightbox"><img src="assets/img/gallery/1.jpg" class="img-fluid" alt=""></a></div>
                <div class="swiper-slide"><a href="{{asset('img/gallery/2.jpg')}}" class="gallery-lightbox"><img src="assets/img/gallery/2.jpg" class="img-fluid" alt=""></a></div>
                <div class="swiper-slide"><a href="{{asset('img/gallery/3.jpg')}}" class="gallery-lightbox"><img src="assets/img/gallery/3.jpg" class="img-fluid" alt=""></a></div>
                <div class="swiper-slide"><a href="{{asset('img/gallery/4.jpg')}}" class="gallery-lightbox"><img src="assets/img/gallery/4.jpg" class="img-fluid" alt=""></a></div>
                <div class="swiper-slide"><a href="{{asset('img/gallery/5.jpg')}}" class="gallery-lightbox"><img src="assets/img/gallery/5.jpg" class="img-fluid" alt=""></a></div>
                <div class="swiper-slide"><a href="{{asset('img/gallery/6.jpg')}}" class="gallery-lightbox"><img src="assets/img/gallery/6.jpg" class="img-fluid" alt=""></a></div>
                <div class="swiper-slide"><a href="{{asset('img/gallery/7.jpg')}}" class="gallery-lightbox"><img src="assets/img/gallery/7.jpg" class="img-fluid" alt=""></a></div>
                <div class="swiper-slide"><a href="{{asset('img/gallery/8.jpg')}}" class="gallery-lightbox"><img src="assets/img/gallery/8.jpg" class="img-fluid" alt=""></a></div>
            </div>
