            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form was-validated" method="post" action="{{route('store.vehicle.details')}}"
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="text" class="border-radius-text form-control"
                                               placeholder="Please enter vehicle title..."
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="text" class="border-radius-text form-control"
                                               placeholder="Please enter vehicle tracker..."
                                               name="tracker_no"
                                               value="{{old('tracker_no')}}"
                                               required>
                                        @if($errors->has('tracker_no'))
                                            <span class="text-danger">{{ $errors->first('tracker_no') }}</span>
                                        @endif
                                        <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="text" class="border-radius-text form-control"
                                               placeholder="Please enter vehicle condition..."
                                               name="vehicle_condition"
                                               value="{{old('vehicle_condition')}}"
                                               required>
                                        @if($errors->has('vehicle_condition'))
                                            <span class="text-danger">{{ $errors->first('vehicle_condition') }}</span>
                                        @endif
                                        <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        @if($errors->has('vehicle_description'))
                                            <span class="text-danger">{{ $errors->first('vehicle_description') }}</span>
                                        @endif
