                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-header text-right">
                            <h4 class="card-title text-left">Edit Employee Details </h4>
                        </div>

                        <div class="card-body">
                            <form class="form was-validated" action="{{route('edit.employee', $getEmployeeId->id)}}"
                                  method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col">
                                        <input type="text" class="border-radius-text form-control" placeholder="Enter First name"
                                               name="first_name" value="{{$getEmployeeId->first_name}}" required>
                                    ...
                                    <div class="col">
                                        <input type="text" class="border-radius-text form-control" placeholder="Enter Last name"
                                               name="last_name" value="{{$getEmployeeId->last_name}}" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="number" class="border-radius-text form-control" placeholder="Enter CNIC #"
                                               name="cnic" value="{{$getEmployeeId->cnic}}" required>
                                        <div class="invalid-feedback">
                                            Please provide cnic #...
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <input type="number" class="border-radius-text form-control" placeholder="Enter Contact #"
                                               name="contact" value="{{$getEmployeeId->contact}}" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="text" class="border-radius-text form-control" name="permanent_address"
                                               ...
                                               value="{{$getEmployeeId->permanent_address}}" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="text" class="border-radius-text form-control" placeholder="Enter Email Address"
                                               name="email" value="{{$getEmployeeId->email}}" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col">
                                        <select id="inputState" class="border-radius-text form-control" name="status"
                                                value="{{$getEmployeeId->isActive}}">
                                            @if($getEmployeeId->isActive =='1')
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="text" class="border-radius-text form-control" placeholder="Description..."
                                               name="description" value="{{$getEmployeeId->description}}">
                                    </div>
                                </div>
                                <br>
