                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-header text-right">
                            <h4 class="card-title text-left">Add New Customer </h4>
                        ...
                        <div class="card-body">
                            <form class="form was-validated" action="{{route('client.store')}}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <select class="border-radius-text form-control" name="gender_id" required>
