                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            {{--                                </div>--}}
                            {{--                            @endif--}}
                            <form class="form was-validated" action="{{route('hotel.store')}}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <input type="email" class="border-radius-text form-control" placeholder="Please enter email"
                                               name="hotel_email"
                                               value="{{old('hotel_email')}}"
                                               required>
                                        @if($errors->has('hotel_email'))
                                            <span class="text-danger">{{ $errors->first('hotel_email') }}</span>
                                        @endif
                                        <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="number" class="border-radius-text form-control" placeholder="Please enter contact #"
                                               name="hotel_contact"
                                               value="{{old('hotel_contact')}}"
                                               required>
                                        @if($errors->has('hotel_contact'))
                                            <span class="text-danger">{{ $errors->first('hotel_contact') }}</span>
                                        @endif
                                        <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="text" class="border-radius-text form-control" placeholder="Please enter hotel Website link"
                                               name="hotel_web">
                                    </div>

                                    <div class="col">
                                        <input type="text" class="border-radius-text form-control" placeholder="Please enter hotel FB Link"
                                               name="hotel_facebook">
                                    </div>
                                </div>
                                <br><br>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="text" class="border-radius-text form-control" placeholder="Please enter hotel address..."
                                               name="hotel_address"
                                               value="{{old('hotel_address')}}"
                                               required>
                                        @if($errors->has('hotel_address'))
                                            <span class="text-danger">{{ $errors->first('hotel_address') }}</span>
                                        @endif
                                        <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <input type="text" class="border-radius-text form-control" placeholder="Please enter hotel description..."
                                               name="hotel_description"
                                        value="{{old('hotel_description')}}"
                                        >
                                        @if($errors->has('hotel_description'))
                                            <span class="text-danger">{{ $errors->first('hotel_description') }}</span>
                                        @endif
                                    </div>
                                </div>
                                <br><br>
