    ...
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li class="dropdown"><a href="#portfolio" class="active"><span>Hotel</span> <i class="bi bi-chevron-down"></i></a>
                    <ul class="">
                        <li><a href="#" class="dropdown-item">H 1</a></li>
                        <li><a href="#" class="dropdown-item">H 2</a></li>
                    </ul>
                </li>


                <li class="dropdown"><a href="#services"><span>Transportation</span> <i class="bi bi-chevron-down"></i></a>
                    <ul class="">
                        <li><a href="#" class="dropdown-item">T 1</a></li>
                        <li><a href="#" class="dropdown-item">T 2</a></li>
                    </ul>
                </li>


                <li class="dropdown"><a href="#"><span>Rent Car</span> <i class="bi bi-chevron-down"></i></a>
                    <ul class="">
                        <li><a href="#" class="dropdown-item">R C 1</a></li>
                        <li><a href="#" class="dropdown-item">R C 2</a></li>
                    </ul>
                </li>


                <li class="dropdown"><a href="#team"><span>Mechanics</span> <i class="bi bi-chevron-down"></i></a>
                    <ul class="">
                        <li><a href="#" class="dropdown-item">M 1</a></li>
                        <li><a href="#" class="dropdown-item">M 2</a></li>
                    </ul>
                </li>


                <li class="dropdown"><a href="#about"><span>Contact Us</span> <i class="bi bi-chevron-down"></i></a>
                    <ul class="">
                        <li><a href="#" class="dropdown-item">R C 1</a></li>
                        <li><a href="#" class="dropdown-item">R C 2</a></li>
                    </ul>
                ...
                {{--                <li><a class="nav-link scrollto" href="#services">Transportation</a></li>--}}
                {{--                <li><a class="nav-link scrollto " href="#portfolio">Rent Car</a></li>--}}
                {{--                <li><a class="nav-link scrollto" href="#team">Mechanics</a></li>--}}
                ...
                {{--                        <li class="dropdown"><a href="#"><span>Deep Drop Down</span> <i class="bi bi-chevron-down"></i></a>--}}
                {{--                            <ul>--}}
        ...
        <li><a class="btn btn-primary" href="{{route('adminPage')}}" style="width: 110px; height: 35px; font-size: 13px;">LOGIN</a></li>
    </div>
...
<section id="hero">
    <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
        <h1>Welcome to North Trip Cycle</h1>
        <h2>We Plan, We Design, We Serve</h2>
            ...
            <div class="row" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-12 d-flex justify-content-center">
                    <ul id="portfolio-flters">
                        <li data-filter="*" class="filter-active">All Hotels</li>
                        <li data-filter=".filter-app">Normal</li>
                        <li data-filter=".filter-card">Luxurious</li>
...
<footer id="footer">
    ...
    <div class="container">
        <div class="copyright">
            &copy; Copyright <strong>North Trip Cycle</strong>. All Rights Reserved
        </div>
        <div class="credits">
            <!--
