    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
                ...
                <li><a class="nav-link scrollto" href="{{route('LoadHotelPage')}}">Hotel</a></li>
                ...
                {{--                <li class="dropdown"><a href="#"><span>Photographer</span> <i class="bi bi-chevron-down"></i></a>--}}
                {{--                    <ul>--}}
                {{--                        <li><a href="#">Photo Graphy</a></li>--}}
        ...
        {{--        <a href="{{route('adminPage')}}"  class="book-a-table-btn scrollto text-center" style="width: 110px;">Register</a>--}}
        ...
        <div id="heroCarousel" data-bs-interval="3500" class="carousel slide carousel-fade" data-bs-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active"
                     style="background: url(assets/img/slide/slider11.jpeg);  background-size: cover;">
                    <div class="carousel-container">
                        <div class="carousel-content">
                            <h2 class="animate__animated animate__fadeInDown"><span>North</span> Trip Cycle</h2>
                            <p class="animate__animated animate__fadeInUp">We Plan, We Design, We Serve</p>
                            <div>
                                {{--                                <a href="#menu" class="btn-menu animate__animated animate__fadeInUp scrollto">Our--}}
                                {{--                                    Menu</a>--}}
                                <a href="#events" class="btn-book animate__animated animate__fadeInUp scrollto"
                                   style="width: 140px;">Events</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-item"
                     style="background: url(assets/img/slide/slider12.jpg); background-size: cover;">
                    <div class="carousel-container">
                        <div class="carousel-content">
                            <h2 class="animate__animated animate__fadeInDown"><span>North</span> Trip Cycle</h2>
                            <p class="animate__animated animate__fadeInUp">We Plan, We Design, We Serve</p>
                ...
                <div class="carousel-item" style="background: url(assets/img/slide/slider2.jpg);">
                    <div class="carousel-background"><img src="{{asset('assets/img/slide/slider2.jpg')}}" alt=""></div>
                    <div class="carousel-container">
                        <div class="carousel-content">
                            <h2 class="animate__animated animate__fadeInDown"><span>North</span> Trip Cycle</h2>
                            <p class="animate__animated animate__fadeInUp">We Plan, We Design, We Serve</p>
                ...
                <!-- Slide 4 -->
                <div class="carousel-item" style="background: url(assets/img/slide/slider15.jpg);">
                    <div class="carousel-background"><img src="{{asset('assets/img/slide/slider15.jpg')}}" alt=""></div>
                    <div class="carousel-container">
                        <div class="carousel-content">
                            <h2 class="animate__animated animate__fadeInDown"><span>North</span> Trip Cycle</h2>
                            <p class="animate__animated animate__fadeInUp">We Plan, We Design, We Serve</p>
                ...
                <!-- Slide 5x -->
                <div class="carousel-item"
                     style="background: url(assets/img/slide/slider19.jpeg); background-size: cover;">
                    {{--                    <div class="carousel-background"><img src="{{asset('assets/img/slide/slider19.jpeg')}}" style="background-size: cover;" ></div>--}}
                    <div class="carousel-container">
                        <div class="carousel-content">
                            <h2 class="animate__animated animate__fadeInDown"><span>North</span> Trip Cycle</h2>
                            <p class="animate__animated animate__fadeInUp">We Plan, We Design, We Serve</p>
...
<!-- ======= Hotel Section ======= -->
                                            ...
                                            <div class="card">
                                                ...
                                                <a href="{{asset('img/' . $hotelDetail->file_name)}}"
                                                   class="gallery-lightbox ">
                                                    ...
                                                    @if($hotelDetail->file_name != "")
                                                        <img src="{{asset('img/' . $hotelDetail->file_name)}}"  alt="" class="img-fluid"/></a>
                                                @else
                                                    <img src="{{asset('img/noImage.jpg')}}"  alt="" class="img-fluid"/></a>
                                                @endif
                                                ...
                                                <div class="card-body">
                                                    <div class="member-info">
                                                        ...
                                                        <a href="{{route('hotel.gallary', $hotelDetail->id)}}" methods="get">
                                                            <button class="btn btn-dark form-control"
                                                                    id="images-buttons">
                                                                <h4 class="text-center" id="images-titles"> View </h4></button>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <!-- ======= Tour Guide Section ======= -->
    <section id="Tour" class="chefs">
        <div class="container">

            <div class="section-title">
                <h2><span>Our Professional Tour Guide</span></h2>
                <p>Ut possimus qui ut temporibus culpa velit eveniet modi omnis est adipisci expedita at voluptas atque
                    vitae autem.</p>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="member">
                        <div class="pic"><img src="{{asset('assets/img/chefs/team-1.jpg')}}" class="img-fluid" alt="">
                        </div>
                        <div class="member-info">
                            <h4>Walter White</h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member">
                        <div class="pic"><img src="{{asset('assets/img/chefs/team-2.jpg')}}" class="img-fluid" alt="">
                        </div>
                        <div class="member-info">
                            <h4>Sarah Jhonson</h4>
                            <span>Patissier</span>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member">
                        <div class="pic"><img src="{{asset('assets/img/chefs/team-3.jpg')}}" class="img-fluid" alt="">
                        </div>
                        <div class="member-info">
    ...
    </section><!-- End Tour Guide Section -->


    <!-- ======= Transportaion Section ======= -->
    <section id="Tgallery" class="gallery">
        <section id="Hgallery" class="gallery">
            <div class="container-fluid">

                <div class="section-title">
                    <h2><span>Transportation Photos</span></h2>
                    <p>Ut possimus qui ut temporibus culpa velit eveniet modi omnis est adipisci expedita at voluptas atque
                        vitae autem.</p>
                </div>
    ...
    </section><!-- End Transportaion Section -->
    ...
    <section id="why-us" class="why-us">
        <div class="container">
            ...
            <div class="section-title">
                <h2><span>Why choose Our Services</span></h2>
                <p>Ut possimus qui ut temporibus culpa velit eveniet modi omnis est adipisci expedita at voluptas atque
                    vitae autem.</p>
            </div>
    ...
    <section id="events" class="events">
        <div class="container">
            ...
            <div class="section-title">
                <h2><span>Organized Events in Gilgit Baltistan</span></h2>
            </div>
    ...
    <section id="specials" class="specials">
        <div class="container">
            ...
            <div class="section-title">
                <h2><span>Check our Special Services</span></h2>
                <p>Ut possimus qui ut temporibus culpa velit eveniet modi omnis est adipisci expedita at voluptas atque
                    vitae autem.</p>
            </div>
